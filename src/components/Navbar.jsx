...
const Navbar = () => {
  ...
  return (
    <>
      <div className={`fixed w-full ${darkMode ? 'dark' : ''}`}>
        <div>
          <div className="flex flex-row justify-between p-5 md:px-32 px-5 bg-white shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
            ...
            <nav className="hidden md:flex flex-row items-center text-lg font-medium gap-8">
              <Link
                ...
                smooth={true}
                duration={500}
                className={`hover:text-${darkMode ? 'gray-300' : 'brightColor'} transition-all cursor-pointer`}
              >
                Home
              </Link>
      ...
      <div className="fixed bottom-5 right-5">
        <button
          className={`p-2 rounded-full ${darkMode ? 'bg-gray-800 text-white' : 'bg-white text-black'} shadow-md`}
          onClick={toggleTheme}
        >
