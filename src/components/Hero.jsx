    ...
    return (
        ...
        <div className='max-h-[500px] relative'>
            ...
            <div className='absolute w-full h-full text-gray-200 max-h-[500px] bg-black/40 flex flex-col justify-center'>
                ...
                <div class="font-custom">Elevate Your Style</div>
                </h1>
                <h1 className='drop-shadow-lg hover:drop-shadow-xl px-4 py-8 text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold shadow-md'> 
                <div class="font-custom">Shop with a Smile </div>
                </h1>
            </div>
